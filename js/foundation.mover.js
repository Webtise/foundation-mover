// Appends targets to itself based screensize

// To use:
// - add 'data-mover' attribute to element
// - add 'data-mover-target="targetId:breakpoint"' attribute to element
// - e.g.
//          <img id="image" src="image.jpg" />
//          <div class="container" data-mover data-mover-target="image:large;"></div>
//  @large
//          <div class="container" data-mover data-mover-target="image:large;"><img id="image" src="image.jpg" /></div>

// To move a target back and forth you will need two instances:
// - e.g.
//          <div class="container" data-mover data-mover-target="image:large down;">
//              <img id="image" src="image.jpg" />
//          </div>
//          <div class="container" data-mover data-mover-target="image:large up;"></div>
//
//  @large or less
//          <div class="container" data-mover data-mover-target="image:large down;">
//              <img id="image" src="image.jpg" />
...
//
//  @large or more
//          <div class="container" data-mover data-mover-target="image:large down;"></div>
//          <div class="container" data-mover data-mover-target="image:large up;">
//              <img id="image" src="image.jpg" />
//          </div>

// You can add multiple targets at various breakpoints too:
//  - e.g.
//          <img id="image" src="image.jpg" />
...
//
// $(document).on('before_move.zf.mover', function(event, target) {console.log(event, target)});
// $(document).on('after_move.zf.mover', function(event, target) {console.log(event, target)});
